...
import com.example.hahalolofake.gallery.GalleryFavoriteAct
import com.example.hahalolofake.gallery.GalleryHomeActivity
...
abstract class ActivityModule {
    ...
    @ContributesAndroidInjector
    abstract fun contributeGalleryHomeActivity(): GalleryHomeActivity

    @ContributesAndroidInjector
    abstract fun contributeGalleryFavoriteAct(): GalleryFavoriteAct
}